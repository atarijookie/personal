...
-- table for storing raw orp values
CREATE TABLE IF NOT EXISTS orp_raw (
  id          BIGSERIAL PRIMARY KEY,
  datetime    TIMESTAMPTZ NOT NULL DEFAULT now(),
  sensor_id   INTEGER NOT NULL,
  orp_mv      DOUBLE PRECISION,
  orp_offset  DOUBLE PRECISION,
  temp        DOUBLE PRECISION,
  ph          DOUBLE PRECISION
);

CREATE TABLE IF NOT EXISTS orp_settings (
  orp_offset  DOUBLE PRECISION,
  ph          DOUBLE PRECISION
);
...
ALTER TABLE orp_raw ADD COLUMN IF NOT EXISTS orp_mv DOUBLE PRECISION;
ALTER TABLE orp_raw ADD COLUMN IF NOT EXISTS orp_offset DOUBLE PRECISION;
ALTER TABLE orp_raw ADD COLUMN IF NOT EXISTS temp DOUBLE PRECISION;
ALTER TABLE orp_raw ADD COLUMN IF NOT EXISTS ph DOUBLE PRECISION;
